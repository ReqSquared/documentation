...
<img
  src="/images/blue_cube_three_1.png"
  alt="Blue Cube Three"
...
The example Air Traffic Controller for Open Requisitions takes the Workforce Planning Cube, feeds it into the Requisition Persona Cube, and produces per-req explainable recommendations that lands on the requisition record as a custom object.
