...
![Blue Cube Three](/images/blue_cube_three.png)
...
The example Air Traffic Controller for Open Requisitions takes the Headcount Optimization signal, feeds it into the Load Balancer to run req-to-recruiter allocation, and produces per-req explainable recommendations that lands on the requisition record as a custom object.
